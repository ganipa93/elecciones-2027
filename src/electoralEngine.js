...
export const provincias = [
    { id: "pba", n: "Buenos Aires", peso: 37.04, sesgo: { uxp: 8, lla: -2, fit: 2 } },
    { id: "caba", n: "CABA", peso: 7.16, sesgo: { lla: 5, pd: 10, uxp: -5 } },
    { id: "cba", n: "Córdoba", peso: 8.66, sesgo: { lla: 12, uxp: -15, pd: 5 } },
    { id: "sfe", n: "Santa Fe", peso: 7.96, sesgo: { lla: 7, uxp: -5, pd: 5 } },
    { id: "mza", n: "Mendoza", peso: 4.25, sesgo: { lla: 10, uxp: -10 } },
    { id: "tuc", n: "Tucumán", peso: 3.73, sesgo: { uxp: 10, lla: -2 } },
    { id: "er", n: "Entre Ríos", peso: 3.24, sesgo: { pd: 5, lla: 2 } },
    { id: "sal", n: "Salta", peso: 3.18, sesgo: { uxp: 5, lla: 5 } },
    { id: "cha", n: "Chaco", peso: 2.83, sesgo: { uxp: 6 } },
    { id: "mis", n: "Misiones", peso: 2.77, sesgo: { uxp: 5, lla: 5 } },
    { id: "cor", n: "Corrientes", peso: 2.69, sesgo: { pd: 8 } },
    { id: "sde", n: "Sgo. del Estero", peso: 2.29, sesgo: { uxp: 30 } },
    { id: "sjn", n: "San Juan", peso: 1.71, sesgo: { lla: 4 } },
    { id: "juj", n: "Jujuy", peso: 1.67, sesgo: { uxp: -5, lla: 5 } },
    { id: "rn", n: "Río Negro", peso: 1.63, sesgo: { uxp: 4, fit: 3 } },
    { id: "neu", n: "Neuquén", peso: 1.56, sesgo: { lla: 8, fit: 4 } },
    { id: "for", n: "Formosa", peso: 1.38, sesgo: { uxp: 25 } },
    { id: "chu", n: "Chubut", peso: 1.31, sesgo: { lla: 6 } },
    { id: "sl", n: "San Luis", peso: 1.19, sesgo: { lla: 12 } },
    { id: "cat", n: "Catamarca", peso: 0.96, sesgo: { uxp: 10 } },
    { id: "lr", n: "La Rioja", peso: 0.86, sesgo: { uxp: 5, lla: 5 } },
    { id: "lp", n: "La Pampa", peso: 0.85, sesgo: { uxp: 2 } },
    { id: "sc", n: "Santa Cruz", peso: 0.75, sesgo: { uxp: 5, fit: 5 } },
    { id: "tf", n: "Tierra del Fuego", peso: 0.42, sesgo: { uxp: 10, fit: 5 } }
];
...
export function simularProvincia(provincia, baseAjuste = {}) {
    let v = {
        lla: 28 + (provincia.sesgo.lla || 0) + (Math.random() * 8 - 4) + (baseAjuste.lla || 0),
        uxp: 26 + (provincia.sesgo.uxp || 0) + (Math.random() * 8 - 4) + (baseAjuste.uxp || 0),
        pro: 14 + (provincia.sesgo.pro || 0) + (Math.random() * 6 - 3) + (baseAjuste.pro || 0),
        ucr: 8 + (provincia.sesgo.ucr || 0) + (Math.random() * 4 - 2) + (baseAjuste.ucr || 0),
